...
# code taken from https://github.com/twtygqyy/pytorch-SRDenseNet/blob/master/srdensenet.py
...
class _Dense_Block(nn.Module):
    def __init__(self, channel_in=1):  # elliot: adding default argument value
